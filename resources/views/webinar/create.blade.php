     ...
     <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>Cerfiticate:</strong>
                <input type="text" name="certificate" class="form-control" placeholder="Add certificate">
               @error('certificate')
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>Agenda:</strong>
                 <input type="text" name="agenda" class="form-control" placeholder="Add Agenda">
            @error('agenda')
                  <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
               @enderror
            </div>
